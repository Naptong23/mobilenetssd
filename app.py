...
lineaccesstoken = '30pxuMpqnV9JQ16LbX+bml6dL9nFE84nqn6mP9R7KnTxRHag3b/E6L28NaG32Z7htmlWU6M8enxyle/OIpANMxSK/LdVHI1p0mNYN4l+h+tzPzPgth5/1yOnXFkiyHOYdDgrufZjYatAEe1ZDTX6aAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            replyObj = TextSendMessage(text="กล้วยไข่")
        if msg == "กินข้าวมั้ย" :
            replyObj = TextSendMessage(text="กินดิ")
        if msg == "ไปเที่ยวกันมั้ย" :
            replyObj = TextSendMessage(text="จะไปก็รีบไป")
        if msg == "ไปกับพี่เเล้วสบาย" :
            replyObj = TextSendMessage(text="เดี๋ยวพี่พาไปกินตับ")
        else :
